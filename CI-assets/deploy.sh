...
mv .git ../git_tmp && mv master_sps_qa_report* .travis.yml ../ && cd .. && rm -rf out && mkdir out && mv master_sps_qa_report* .travis.yml out && mv git_tmp out/.git && cd out 
